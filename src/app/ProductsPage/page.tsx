...
const Page = () => {
  ...
  return (
    <div className="container">
      <div className="BreadCrams text-[16px] flex gap-2 items-center">
        <h3>Home</h3>
        <Image src={"/arrow.svg"} alt="Arrow" width={16} height={16} />
        <h3>Casual</h3>
      </div>
      <div className="content flex gap-6 h-max">
        <div className="sideBar w-[295px] px-[24px] py-[20px] flex flex-col gap-[24px] border rounded-[20px]">
        ...
        <div className="products_container flex flex-wrap gap-5">
          {Data.map((item, idx) => {
